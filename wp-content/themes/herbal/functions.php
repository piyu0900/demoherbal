...
function display_features_element()
{
	?>
    	<textarea type="text" name="features" id="features"  cols="72" rows="7"><?php echo get_option('features'); ?></textarea>
    <?php
}

function display_herbal_element()
{
	?>
    	<textarea type="text" name="herbal" id="herbal"  cols="72" rows="7"><?php echo get_option('herbal'); ?></textarea>
    <?php
}
...
{
	?>
		<textarea type="text" name="hour" cols="72" rows="7" id="hour"><?php echo get_option('hour'); ?></textarea>
    <?php
}
...
function display_theme_panel_fields()
{
    ...
    add_settings_field("instragram_url", "Gplus Profile Url", "display_instragram_element", "theme-options", "section");
	add_settings_field("homeremotesensing", "Homepage Research and Development", "display_homeremotesensing_element", "theme-options", "section");
	add_settings_field("features", " Homepage Features", "display_features_element", "theme-options", "section");
	add_settings_field("herbal", "Homepage Herbal Extracts & Essential oils", "display_herbal_element", "theme-options", "section");
    ...
    add_settings_field("hour", "Homepage Clients", "display_hour_element", "theme-options", "section");
	...
	register_setting("section", "features");
	register_setting("section", "herbal");
